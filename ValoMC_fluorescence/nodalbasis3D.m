function node_solution = nodalbasis3D(vmcmesh,solution)
sz=size(vmcmesh.r,1);
...
for i=1:size(solution.element_fluence,1)
    ...
    a2=solution.element_radiance(i,:)/4;
    ...
    node_solution.element_radiance(vmcmesh.H(i,4),:)=node_solution.element_radiance(vmcmesh.H(i,4),:)+a2;
end
for i=1:size(solution.boundary_exitance,1)
    ...
    a6=solution.boundary_radiance(i,:)/3;
    ...
    node_solution.boundary_radiance(vmcmesh.BH(i,3),:)=node_solution.boundary_radiance(vmcmesh.BH(i,3),:)+a6;
end
sz=size(vmcmesh.r,1);
...
for i=1:size(solution.F_element_fluence,1)
    a1=solution.F_element_fluence(i,:)/4;
    ...
    node_solution.F_element_fluence(vmcmesh.H(i,4),:)=node_solution.F_element_fluence(vmcmesh.H(i,4),:)+a1;
    a2=solution.F_element_radiance(i,:)/4;
    ...
    node_solution.F_element_radiance(vmcmesh.H(i,4),:)=node_solution.F_element_radiance(vmcmesh.H(i,4),:)+a2;
end
for i=1:size(solution.F_boundary_exitance,1)
    a3=solution.F_boundary_exitance(i,:)/3;
    ...
    node_solution.F_boundary_exitance(vmcmesh.BH(i,3),:)=node_solution.F_boundary_exitance(vmcmesh.BH(i,3),:)+a3;
    a4=solution.F_R_boundary_exitance(i,:)/3;
    ...
    node_solution.F_R_boundary_exitance(vmcmesh.BH(i,3),:)=node_solution.F_R_boundary_exitance(vmcmesh.BH(i,3),:)+a4;
    a5=solution.F_boundary_fluence(i,:)/3;
    ...
    node_solution.F_boundary_fluence(vmcmesh.BH(i,3),:)=node_solution.F_boundary_fluence(vmcmesh.BH(i,3),:)+a5;
    a6=solution.F_boundary_radiance(i,:)/3;
    ...
    node_solution.F_boundary_radiance(vmcmesh.BH(i,3),:)=node_solution.F_boundary_radiance(vmcmesh.BH(i,3),:)+a6;
end
end
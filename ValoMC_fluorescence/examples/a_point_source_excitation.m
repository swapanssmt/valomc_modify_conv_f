...
% Create a finer mesh
h_disc=1.0;
x_arr = h_disc/2:h_disc:25-h_disc/2;
y_arr = h_disc/2:h_disc:25-h_disc/2;
z_arr = h_disc/2:h_disc:25-h_disc/2;
% h_disc=0.2;
...
Point_LS=[12.5+h_disc/4 12.5+h_disc/4 25];
%Point_LS=[12.5 12.5 25];
x_coord=vmcmesh.r(:,1);
y_coord=vmcmesh.r(:,2);
z_coord=vmcmesh.r(:,3);
temp=vmcmesh.BH;

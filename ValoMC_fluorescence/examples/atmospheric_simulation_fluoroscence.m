...
vmcmedium.scattering_coefficient_ex = 98.4;
vmcmedium.scattering_coefficient_em = 98.4;
vmcmedium.absorption_coefficient_ex_sol = 0.026; % repeat six times
vmcmedium.absorption_coefficient_ex_f = 0.005; % repeat six times
vmcmedium.absorption_coefficient_em_sol = 0.031; % repeat six times

...
% Create a finer mesh
h_disc=1.0;
x_arr = h_disc/2:h_disc:26-h_disc/2;
y_arr = h_disc/2:h_disc:26-h_disc/2;
z_arr = h_disc/2:h_disc:26-h_disc/2;
% h_disc=0.2;
...
vmcmedium.scattering_coefficient_ex = 5.0;
vmcmedium.scattering_coefficient_em = 5.0;
vmcmedium.absorption_coefficient_ex_sol = 0.005; % repeat six times
vmcmedium.absorption_coefficient_ex_f = 0.0; % repeat six times
vmcmedium.absorption_coefficient_em_sol = 0.0; % repeat six times
...
radius_s=2;
center_s=[13.0+h_disc/(2)^5 13.0+h_disc/(2)^5 19];
...
Point_LS=[13.0+h_disc/(2)^5 13.0+h_disc/(2)^5 26];
x_coord=vmcmesh.r(:,1);
y_coord=vmcmesh.r(:,2);
z_coord=vmcmesh.r(:,3);
temp=vmcmesh.BH;
